...
<body class="align">
  ...
  <div class="grid align__item">
    ...
    <div class="register">
      ...
      <input type="text" class="form-control" name="txtUsername" id="txtUsername" placeholder="User name"> <br>

      <input type="password" class="form-control" name="txtPassword" id="txtPassword" placeholder="Password"><br>
      <button type="submit" name="btnSignIn" class="btn btn-primary btn-block">Log In</button>
