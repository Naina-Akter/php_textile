...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		$html="<table class='table'>";
			$html.="<tr><th colspan='3'><a class=\"btn btn-warning\" href=\"create-productcategory\"><b>New Product Category</b></a></th></tr>";
		if($action){
		...
		while($productcategory=$result->fetch_object()){
			...
			$html.="<tr><td>$productcategory->id</td><td>$productcategory->name</td><td>$productcategory->section_id</td><td>$productcategory->created_at</td><td>$productcategory->updated_at</td> $action_buttons</tr>";
		}
		$html.="</table>";
