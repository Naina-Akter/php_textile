...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		$html="<table class='table'>";
			$html.="<tr><th colspan='3'><a class=\"btn btn-warning\" href=\"create-production\">New Production</a></th></tr>";
		if($action){
		...
		while($mfgproduction=$result->fetch_object()){
			...
			if($action){
				...
				$action_buttons.= action_button(["id"=>$mfgproduction->id, "name"=>"Details", "value"=>"Details", "class"=>"info", "url"=>"details-production"]);
				$action_buttons.= action_button(["id"=>$mfgproduction->id, "name"=>"Edit", "value"=>"Edit", "class"=>"primary", "url"=>"edit-production"]);
