        ...
        <div class="brand-section">
              ...
              <table class="table table-active">
                <thead>
                  ...
                  <tr>
                    ...
                    <th>
                      <?php
                      echo Product::html_select_finished_goods();
                      ?>
                    </th>
          ...
          <div class="row no-print">
            <div class="col-12">
              ...
              <button type="button" id="btnProcessOrder" class="btn float-right"  style="background-color:rgb(130, 202, 6)"><i class="far fa-credit-card"></i><b> Process Order </b></button>
