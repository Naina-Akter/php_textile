      ...
      <div class="col-12">
        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row">
            <div class="col-12">
              <h3 class="text-center mt-2">
                 </i><b> BD-Textile Ltd.</b></h3> 
                 <p class="text-center">Gazipur,Dhaka <br>Con: 017883334</p> <hr>
              <small class="float-right mb-2"><b>Date: <?php echo date("d M Y") ?></b></small>
            </div>
            <!-- /.col -->
          </div>
          <!-- info row -->
          ...
          <div class="row no-print">
            <div class="col-12">
              <a href="invoice-print.html" rel="noopener" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> Print</a>
